          ...
          <div className="flex items-center gap-2">
            ...
            {searchParams.get("restaurante") && (
              <button
                ...
                className="border border-border h-8 rounded-lg inline-flex items-center justify-center px-3 text-[13px] font-medium transition-colors hover:bg-muted shrink-0"
              >
                Volver a superadmin
              </button>
            )}
